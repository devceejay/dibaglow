...
DibaGlow is a modern, responsive, user-centered website for a fictional medical spa brand. Built with HTML, CSS, and JavaScript, it highlights services, builds trust with testimonials, answers client questions through a clear FAQ, and drives conversions via an accessible contact form. It was created to demonstrate my ability to bring a wellness brand identity to life through thoughtful design and clean development practices.
